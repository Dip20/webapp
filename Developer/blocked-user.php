...
$query="SELECT * FROM tbl_login WHERE block='Yes'";
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">View Blocked User</li>
  </ol>
</nav>

<div class="container text-center">
  <h4> View blocked User</h4>
</div>

<!-- display total  activity -->
<p class="text text-right pr-3" >Total Blocked User: <strong> <?php echo $result;?></strong></p>
...
if ($result!=0)
{
 ...
 ?>
      ...
      <td data-label="Action"><a href="unblock-user.php?em=<?php echo $data['Email'];?>"  class="btn btn-sm btn-success <?php echo $access; ?>">Unblock</a>

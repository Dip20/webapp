...
<div class="container text-center">
  <h4> View Contact Request</h4>
</div>

<!-- display total  activity -->
<p class="text text-right pr-3" >Total Contact Message: <strong> <?php echo $result;?></strong></p>
...
if ($result!=0)
{
 ...
 ?>
      ...
      <td  data-label="Name" scope="col"><?php echo $data['name']; ?></td>
      <td  data-label="Email" scope="col"><?php echo $data['email']; ?></td>
      <td  data-label="Contact NO" scope="col"><?php echo $data['contactno']; ?></td>
      <td  data-label="Message" scope="col" title="<?php echo $data['message']; ?>"><?php echo $data['message']; ?></td>
      <td  data-label="Timestamp" scope="col" title="<?php echo $data['timestamp1']; ?>"><?php echo $data['timestamp1']; ?></td>
      </tr>
<?php

...
$userdata=$_SESSION['user'];//assign session variable
...
//Logout button click ,destroy session and redirect page to login.php
if (isset($_POST['logout']))
{
 ...
 $query="SELECT * from tbl_complain where technicianassigned='$userdata' and status='pending' ORDER BY id DESC";
...
$_SESSION['export-name']="Pending jobs(user-view)";
...
<br><br><br>
<p class="text pl-3"><?php if ($result!=0) {echo "End of the result";} else{echo '<p class="text text-center">No Data Found</p>';}?></p>
<br>

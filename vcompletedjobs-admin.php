...
$_SESSION['export-name']="Completed jobs(Admin-view)";
...
<p class="total" >Total completed : <strong> <?php echo $result;?></strong>  jobs this month.</p>
...
?>
          ...
          <td  data-label="Technician" scope="col"><?php echo $data['technicianassigned']; ?></td>

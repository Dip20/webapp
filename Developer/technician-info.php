...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Technician info</li>
  </ol>
</nav>
...
if ($result!=0)
{
 ...
 ?>
      ...
      <td  data-label="Email" scope="col"><?php echo $data['emailid']; ?></td>
      <td data-label="Action"><a href="delete-technician.php?em=<?php echo $data['emailid'];?>"  class="btn btn-sm btn-danger <?php echo $access; ?>">Delete</a></td>
      </tr>
<?php
